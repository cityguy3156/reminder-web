...
try {
  ...
  mount(parent) {
    ...
    // Images
    this.btnUploadImages.onclick = () => this.fileInput.click();
    ...
    this.btnClearImages.onclick = () => this.ui.clearImages();
    ...
    this.btnUploadSounds.onclick = () => this.soundsInput.click();
  ...
  _renderWordsList() {
    ...
    for (let i = 0; i < ws.length; i++) {
      ...
      chip.textContent = ws[i] + " ×";
      chip.className = "wordChip";
      chip.onclick = () => {
        this.ui.removeWordAt(i);
        this._renderWordsList();
      };
